<template>
  <div class="bg-gray-700">
    <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-auto">
      <div 
        id="profile" 
      ...
      >
        ...
        <div class="p-4 md:p-12 text-center lg:text-left text-white">			
          ...
          <div class="rounded bg-white-300">
          ...
          <div class="flex items-end space-around w-1/2 ">
            <div class="text-xl font-bold pt-8 lg:pt-0 mr-3">
              project
            </div>
...
<!-- 
        ...
        <div class="bg-white rounded-r m-2">
          <div class="flex">
            <div class="m-3 bg-gray-300 rounded">
